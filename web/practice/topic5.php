                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                ?>
                                            <form name="form1" method="post" action="">
                                                ...
                                                <br />
                                                <input type="submit" name="submit" value="提交" style="padding: 4px;padding-left: 9px;padding-right: 9px;text-indent: 0;"/>
                                                <input type="reset" name="reset" value="重置" style="padding: 4px;padding-left: 9px;padding-right: 9px;text-indent: 0;"/>
                                                </center>
                                            </form>
                                            <h2 align="center">
                                                最近的10条留言为：
