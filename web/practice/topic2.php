            ...
            <div class="content">
                <nav class="l">
                    <ul>
                        ...
                        <li class="firstNav "><a href="./topic1.php?name=1">XSS输出在HTML中</a></li>
                        <li class="firstNav active"><a href="./topic2.php?name=2">XSS输出在HTML属性中</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="mnc-center">
                                        ...
                                        ?>
                                            <h4>您的姓名：<input type="text" value="<?php if (isset($_GET['name'])) {echo $_GET['name'];}?>"></h4>
                                    </div>
                                </div>
                            </div>
